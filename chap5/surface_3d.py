...
n_grids = 51            
c = n_grids / 2    # if you usr python3   c = n_grids / 2 
nf = 2                  
...
noise = [np.complex(x, y) for x, y in np.random.uniform(-1,1,((2*nf+1)**2/2, 2))]   # if you usr python3  noise = [np.complex(x, y) for x, y in np.random.uniform(-1,1,((2*nf+1)**2//2, 2))]  
